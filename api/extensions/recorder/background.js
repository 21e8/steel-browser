...
const baseApiUrl = process.env.VITE_API_URL || "http://localhost:3000";
const LOCAL_API_URL = `${baseApiUrl}/v1/events`;
const FALLBACK_API_URL = `${baseApiUrl}/v1/events`; // Need to point to 0.0.0.0 in some deploys
